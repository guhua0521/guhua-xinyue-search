...
INSERT INTO `qf_conf` VALUES (39, 'ranking_type', '0', '热播榜单', '', 0, 2, '无图模式=>0\n有图模式=>1', 3, 1, 79, 1, 1725159933, 1725160022);
...
INSERT INTO `qf_conf` VALUES ('69', 'is_quan_zc', '1', '检测资源', '开启后全网搜将会过滤失效的资源；支持夸克和阿里网盘', '0', '2', '开启=>1\n关闭=>0', '1', '1', '1', '1', '1744882765', '1744882765');
...
(83, 'ad_popup_enable', '0', '进站弹窗广告开关', '开启后进入网站自动弹出广告，每个访客每次进站只弹一次', 0, 2, '开启=>1\n关闭=>0', 0, 1, 79, 1, 1754380800, 1754380800),
(84, 'ad_popup_title', '', '弹窗标题', '弹窗顶部标题，可留空', 0, 0, NULL, 0, 1, 78, 1, 1754380800, 1754380800),
(85, 'ad_popup_image', '', '弹窗图片', '弹窗顶部图片地址，可留空；有图时显示在标题上方', 0, 4, NULL, 0, 1, 77, 1, 1754380800, 1754380800),
(86, 'ad_popup_content', '', '弹窗内容', '支持文字或HTML代码，可留空', 0, 1, NULL, 0, 1, 76, 1, 1754380800, 1754380800),
(87, 'ad_popup_link', '', '弹窗跳转链接', '点击按钮跳转的链接；留空则点击按钮仅关闭弹窗', 0, 0, NULL, 0, 1, 75, 1, 1754380800, 1754380800),
(88, 'ad_popup_btn', '知道了', '按钮文字', '弹窗底部按钮显示的文字', 0, 0, NULL, 0, 1, 74, 1, 1754380800, 1754380800);
