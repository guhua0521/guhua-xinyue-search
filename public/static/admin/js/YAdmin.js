...
var ADMIN_COOKIE_NAME = (typeof window.ADMIN_COOKIE_NAME !== 'undefined' && window.ADMIN_COOKIE_NAME) ? window.ADMIN_COOKIE_NAME : 'access_token';
var access_token = getCookie(ADMIN_COOKIE_NAME);
var PostBase = {
...
function logout() { 
    ...
    if (r==true){
        document.cookie = ADMIN_COOKIE_NAME + '=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/';
        axios.post('/admin/admin/logout', Object.assign({}, PostBase))
            .then(function (res) {
                if (res.data.code == 200) {
                    window.location.href = "/qfadmin?site=main"
                } else { 
